...
<div id="quote" class="modal_reqCont">
  <!-- Modal content -->
  <div class="modal-content-reqCont">
    ...
    if(isset($_SESSION['email'])) {
      ?>
      <iframe style="margin: 0 auto;" id="quote" name="quote" src="requesta.php" width="1024px" height="730px" marginwidth="0" marginheight="0" frameborder="0" scrolling="yes" >Your web browser does not support this content.</iframe>
      <?php
    }
...
<div id="contact" class="modal_reqCont">
  <!-- Modal content -->
  <div class="modal-content-reqCont">
