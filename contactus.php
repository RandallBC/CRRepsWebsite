    ...
    <td style="float: left; width: 485px; border-right: 1px solid #DB5A0A; ">
            ...
            <div id="enquiry" style="padding-left: 50px;">
              ...
              <table border="0px">
                <tr>
                  ...
                  <td><input class="formText" type="text" id="firstName" name="firstName" /></td>
                </tr>
                <tr>
                  <td valign="top" class="labeldatos">Last Name <span style="color: #e00000">*</span></td>
                  <td><input class="formText" type="text" id="lastName" name="lastName" /></td>
                </tr>
                <tr>
                  <td valign="top" class="labeldatos">Telephone <span style="color: #e00000">*</span></td>
                  <td><input class="formText" type="text" id="tel" name="tel" /></td>
                </tr>
                <tr>
                  <td valign="top" class="labeldatos">E-mail <span style="color: #e00000">*</span></td>
                  <td><input class="formText" type="text" id="emailAdr" name="emailAdr"/></td>
                </tr>
                <tr>
                  <td valign="top" class="labeldatos">Country <span style="color: #e00000">*</span></td>
                  <td><select id="country" name="country" class="formList">
                ...
                <tr>
                  ...
                  <td><input class="formText" type="text" id="state" name="state"  required="yes"/></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><textarea name="comment" id="comment" style="width: 300px; height: 60px; resize: none;" ></textarea></td>
                </tr>
                <tr>
                  <td colspan="2"><p class="divLine">Please select the department you would like this enquiry to be forwarded to:</p></td>
                </tr>
                <tr><td colspan="2">
                  <select id="dep" name="dep" class="formList" style="width: 100%;">
              ...
              <div id="warnContact" class="warnContact"></div>
              <div class="buttsContact">
                <input type="text" hidden id="captchaVer" value="0" >
                <input type="button" class="buttContact" name="Send" value="Send" onclick="sendContact();" />
                <input type="button" class="buttContact" name="clear" value="Clear" onclick="ContactClearFields();" />
              </div>
            </div>
          </td>
        </tr>
      ...
      function sendContact() {
        ...
        if ((firstName == "") || (lastName == "") || (phone == "") || (emailAdr == "") || (country == "")) {
          ...
          setTimeout(function(){
            document.getElementById("warnContact").style.display = "none";
          }, 2000);
        } else if ($("#captchaVer").val() == "0") {
          $("#warnContact").html("<p style='color: #9c1b2d;'>Please complete the captcha</p>");
          document.getElementById("warnContact").style.display = "block";
          setTimeout(function(){
            document.getElementById("warnContact").style.display = "none";
          }, 2000);
