...
<div id="rotator">
    <iframe src="banner/travel/slider.php" width="1020" height="310" scrolling="no" marginwidth="0px" marginheight="0px" frameborder="0" ></iframe>
</div>
...
<div id="datos">
    ...
    <table border="0px">
        <tr>
            <td id="lateralmenu" valign="top">
                <?php include ("menu_travelguide.php");?>
            </td>
            <td id="present" valign="top" style="padding: 5px;">
