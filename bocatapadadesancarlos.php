...
<style>
    ...
    <div class="post" id="derechaConten">
        ...
        <div style="float: left; margin-top: 30px;">  <?php include 'menulateral.php'; ?>  </div>


        <div style="float: left; width: 800px; margin-left: 30px; margin-top: 30px ">

            <h2 id="titulotexto">Destinations - Northern Region - Boca Tapada de San Carlos</h2>
...
require_once 'plantilla_destinations.php';
?>