	...
	<body>
		<div id="wrapper">
			...
			<div id="tabs">
				...
				<div id="blue">
					<img src="../../../images/maps/dom-ballena.png" alt="blue_muffin" />
					<h3 style="visibility: hidden;">Map</h3>
				</div>

				<div id="pink">
					<h3>Dominical &amp; Ballena Bay Info</h3>
					<p>Info de Dominical y bahia Ballena .</p>
				...
				<div id="white">
					<iframe  src="../../subregions/dominical_hypa/dominical.php" width="750px" height="325px" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" ></iframe>
