	...
	<body>
		<div id="wrapper">
			...
			<div id="tabs">
				...
				<div id="blue">
					<img src="../../../images/maps/jaco.png" alt="blue_muffin" />
					<h3 style="visibility: hidden;">Map</h3>
				</div>

				<div id="pink">
					<h3>Jaco, Herradura &amp; Hermosa Info</h3>
					<p>Info de estas playas.</p>
				...
				<div id="white">
					<iframe  src="../../subregions/jhyhbeach_hypa/jhyh.php" width="750px" height="325px" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" ></iframe>
