	...
	<body>
		<div id="wrapper">
			...
			<div id="tabs">
				...
				<div id="pink">
					<h3>Sta Elena &amp; Monteverde Information</h3>
					<p>Info de Santa Elena y monteverde.</p>
				...
				<div id="white">
					<iframe  src="../../subregions/elenamonte_hypa/elenamonte.php" width="750px" height="325px" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" ></iframe>
