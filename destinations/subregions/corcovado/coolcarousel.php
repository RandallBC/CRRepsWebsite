	...
	<body>
		<div id="wrapper">
			...
			<div id="tabs">
				...
				<div id="blue">
					<img src="../../../images/maps/pto_jimenez.png" alt="blue_muffin" />
					<h3 style="visibility: hidden;">Map</h3>
				</div>

				<div id="pink">
					<h3>Corcovado &amp; Pto. Jimenez Info</h3>
					<p>Info de Corcovado &amp; Pto. Jimenez.</p>
				...
				<div id="white">
					<iframe  src="../../subregions/corcovado_hypa/corcovado.php" width="750px" height="325px" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" ></iframe>
