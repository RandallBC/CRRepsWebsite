	...
	<body>
		<div id="wrapper">
			...
			<div id="tabs">
				...
				<div id="blue">
					<img src="../../../images/maps/bijagua.png" alt="blue_muffin" />
					<h3 style="visibility: hidden;">Map</h3>
				</div>

				<div id="pink">
					<h3>Bijagua Information</h3>
					<p>Info de Bijagua de Upala.</p>
				...
				<div id="white">
					<iframe  src="../../subregions/bijagua_hypa/bijagua.php" width="750px" height="325px" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" ></iframe>
