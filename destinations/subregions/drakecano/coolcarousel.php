	...
	<body>
		<div id="wrapper">
			...
			<div id="tabs">
				...
				<div id="blue">
					<img src="../../../images/maps/drake.png" alt="blue_muffin" />
					<h3 style="visibility: hidden;">Map</h3>
				</div>

				<div id="pink">
					<h3>Drake Ca&ntilde;o Information</h3>
					<p>Info de Drake y Ca&ntilde;o.</p>
				...
				<div id="white">
					<iframe  src="../../subregions/drakecano_hypa/drakecano.php" width="750px" height="325px" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" ></iframe>
